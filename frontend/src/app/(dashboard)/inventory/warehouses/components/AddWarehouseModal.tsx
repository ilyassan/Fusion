...
interface AddWarehouseModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (newWarehouse: Omit<Warehouse, "id" | "totalItems" | "totalValue" | "utilizationRate">) => void;
}

export const AddWarehouseModal: React.FC<AddWarehouseModalProps> = ({ isOpen, onClose, onSave }) => {
  const [formData, setFormData] = useState({
    name: "",
    location: "",
    capacity: "",
    capacityUnit: "m²" as const,
    contact: "",
    phone: "",
    email: "",
  });
